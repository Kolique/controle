...
def check_data(df):
    ...
    df_with_anomalies.loc[condition_num_tete_vide, 'Anomalie'] += 'Tête manquante / '
    ...
    df_with_anomalies.loc[(df_with_anomalies['Latitude'] == 0) | (df_with_anomalies['Longitude'] == 0), 'Anomalie'] += 'Coordonnées GPS nulles / '
    ...
    df_with_anomalies.loc[kamstrup_len_condition, 'Anomalie'] += "KAMSTRUP: compteur ≠ 8 chiffres / "
    ...
    df_with_anomalies.loc[condition3, 'Anomalie'] += "KAMSTRUP: lettres dans compteur ou tête / "
    ...
    df_with_anomalies.loc[condition5, 'Anomalie'] += "Sappel: tête DME invalide / "
    ...
    df_with_anomalies.loc[condition6, 'Anomalie'] += "Sappel: format compteur invalide / "
    ...
    df_with_anomalies.loc[condition8, 'Anomalie'] += "Sappel: incohérence compteur / marque / "
    ...
    df_with_anomalies.loc[condition_sappel_tete, 'Anomalie'] += "Sappel: tête ne commence pas par DME / "

    condition_sappel_protocole = is_sappel & (annee_fabrication_num > 22) & (df_with_anomalies['Protocole Radio'] != 'OMS')
    df_with_anomalies.loc[condition_sappel_protocole, 'Anomalie'] += "Sappel: protocole ≠ OMS / "
